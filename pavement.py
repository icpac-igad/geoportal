...
try:
    from icpac_geoportal.local_settings import *
except ImportError:
    from icpac_geoportal.settings import *
...
def _reset():
    ...
    sh("rm -rf icpac_geoportal/development.db")
    sh("rm -rf icpac_geoportal/uploaded/*")
    _install_data_dir()
