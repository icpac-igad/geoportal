...
echo "-----------------------------------------------------"
echo "STARTING icpac_geoportal RESTORE $(date)"
echo "-----------------------------------------------------"
...
SOURCE_URL=$SOURCE_URL TARGET_URL=$TARGET_URL ./icpac_geoportal/br/backup.sh $BKP_FOLDER_NAME/$NEW_UUID
...
echo "-----------------------------------------------------"
echo " - Original Backup of $TARGET_URL --> /$BKP_FOLDER_NAME/$NEW_UUID/"
echo "FINISHED icpac_geoportal RESTORE $(date)"
echo "-----------------------------------------------------"
